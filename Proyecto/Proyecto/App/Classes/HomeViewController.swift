...
class HomeViewController: UIViewController{
    ...
    @IBAction func clickBtnProducto(_ sender: Any) {
        
        self.navigationController?.pushViewController(ProductoViewController(email: self.email, provider: .basic), animated: true)
    }
